...
- Verified the six-choice picker, canyon, reservoirs, and cavern visually in the browser. Discovery chaos remains paused after closing the picker.
- Tests verify five distinct starter-only layouts, empty-world reset, discovery-free generation, reproducible shuffled material placement, all 200 material IDs represented, and save compatibility.
